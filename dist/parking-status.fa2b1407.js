...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/parking-status.js":[function(require,module,exports) {
parking_data = {
  parking_info: [{
    parking_id: 0,
    name: "UG parking - A",
...
$(document).ready(function () {
  ...
  loadData();
  $results_panel.on("click", ".osd-parking", parkingClicked); // $main_panel.on("click", ".osd-route-result", resultOnClick)
});
...
function parkingClicked() {
  ...
  if (selected_parking != null) selected_parking.removeClass("focus");
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/parking-status.js"], null)
//# sourceMappingURL=/parking-status.fa2b1407.js.map